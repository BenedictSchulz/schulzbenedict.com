...
Diese Website wird bei einem externen Dienstleister gehostet (Hetzner - https://www.hetzner.com/). Die personenbezogenen Daten, die auf dieser Website erfasst werden, werden auf den Servern des Hosters gespeichert. Hierbei kann es sich v. a. um IP-Adressen, Kontaktanfragen, Meta- und Kommunikationsdaten, Vertragsdaten, Kontaktdaten, Namen, Websitezugriffe und sonstige Daten, die über eine Website generiert werden, handeln.
...
Diese Website verwendet nur technisch notwendige Cookies für die Theme-Einstellung (hell/dunkel). Es werden keine Tracking-Cookies oder Cookies für Werbezwecke verwendet.
...
Sie haben ferner das Recht, bei der zuständigen Aufsichtsbehörde Beschwerde einzulegen (Art. 77 DSGVO).
